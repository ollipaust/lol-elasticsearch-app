...
export const fighter = '#ff9900'
export const assassin = '#dc3912'
export const mage = '#0099c6'
export const tank = '#5A2A27'
export const support = '#73C507'
export const marksman = '#990099'
